...
var forms = function forms() {
  ...
  var message = {
    loading: 'Загрузка...',
    success: 'Спасибо. Скокро мы с вами свяжемся',
...
var tabs = function tabs(headerSelector, tabSelector, contentSelector, activeClass) {
  ...
  header.addEventListener('click', function (e) {
    ...
    if (target && (target.classList.contains(tabSelector.replace(/\./, '')) || // экранируем точку, т.к. переменная приходит с точкой ".class"
